This branch includes modifications needed for the WGE engine.

These modifications include:
- Changing the directory structure and removing unused files
- Modifying imgui_impl_opengl3.cpp to include glew instead of gl3w
- Adding scaling in imgui_impl_glfw.cpp
